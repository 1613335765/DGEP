...
# 定义编码器
latent_dim = 600  # 定义潜在变量的维度
hidden_layer_1 = Dense(4096, activation='relu')(input_layer)
hidden_layer_2 = Dense(2048, activation='relu')(hidden_layer_1)
hidden_layer_3 = Dense(1024, activation='relu')(hidden_layer_2)
hidden_layer_4 = Dense(512, activation='relu')(hidden_layer_3)
hidden_layer_5 = Dense(256, activation='relu')(hidden_layer_4)
hidden_layer_6 = Dense(128, activation='relu')(hidden_layer_5)
hidden_layer_7 = Dense(64, activation='relu')(hidden_layer_6)
z_mean = Dense(latent_dim)(hidden_layer_5)
z_log_var = Dense(latent_dim)(hidden_layer_5)
...
decoder_hidden_4 = Dense(512, activation='relu')
decoder_hidden_5 = Dense(1024, activation='relu')
decoder_hidden_6 = Dense(2048, activation='relu')
decoder_hidden_7 = Dense(4096, activation='relu')
decoder_output = Dense(input_shape)
...
decoder_input = decoder_hidden_4(decoder_input)
decoder_input = decoder_hidden_5(decoder_input)
decoder_input = decoder_hidden_6(decoder_input)
decoder_input = decoder_hidden_7(decoder_input)
decoder_output = decoder_output(decoder_input)
...
df_new.to_csv("..\\datasets\\features_epoch=150_ycc=7.csv", index=False)